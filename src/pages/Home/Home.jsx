                    ...
                    <section id='about' className='about'>
                        <div className="container">
                            <div className="section-title">
                                <h2>Acerca de mi</h2>
                                <p>Ingeniero en informática de la universidad de La Sabana enfocado en desarrollo web e hibrido en nuevas
                                    tecnologias, manejo de bases de datos relacionales y no relacionales.</p>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6">
                                            <ul>
                                                <li><i className="icofont-rounded-right"></i> <strong>Edad:</strong> 22</li>
                                                <li><i className="icofont-rounded-right"></i> <strong>Titulo:</strong> Ingeniero en informática</li>
                                                <li><i className="icofont-rounded-right"></i> <strong>Correo personal:</strong>
